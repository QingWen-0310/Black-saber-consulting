...
kable(sum_filtered_table, caption = "Table 3: Median statistics by gender")
```
...
knitr::kable(hire2_mod_table, align = c("r", "r"), caption = "Table 4.Coefficient estimates for the logistic model built for hiring phase-II")
```
...
knitr::kable(hire2_temp, caption = "Table 4.Phase-II information for the two applicants with a tie in phase III")
```
